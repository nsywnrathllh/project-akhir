    ...
    <form action="">
        <div class="body-container">
            <div class="logo-container" style="display: flex; justify-content: center; align-items: center;">
                <img style="max-width:200px; max-height:200px; margin-right: 35px;" src="{{ asset('logo/logo.png') }}">
            </div>
            <div class="text-center">
                <input type="text" class="text-capitalize fst-italic bg-transparent border-0" id="address" value="{{ $setting->address }}" readonly>
            </div>
            <div class="mt-3">
                <div class="text-start ps-1">
                    ...
                    <div class="text-center mt-4">
                        <img src="{{ (new \chillerlan\QRCode\QRCode)->render(json_encode($guestData->id ?? null)) }}" alt="QR" style="width: 150px; height: 150px;">
                    </div>
                </div>
            </div>
            <p class="mt-3">-</p>
